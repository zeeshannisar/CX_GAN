...
Following [VA-GAN: Visual Feature Attribution using Wasserstein GANs](https://arxiv.org/abs/1711.08998), we define CX as [Step-2](https://github.com/zeeshannisar/Research-Paper-Contribution/blob/master/Cascaded%20Model/Synthetic%20Data/implementation/Step%202-Proposed%20approach%20to%20detect%20infectious%20Regions.ipynb) as a map `M(x)` that is when added to input image x<sub>i</sub> produce counterfactual image y<sub>i</sub>. Finally we generate heatmaps for a better visualization.
